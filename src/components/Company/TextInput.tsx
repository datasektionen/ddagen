...
export function TextInput({
  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <textarea
        ref={textAreaRef}
        className={`relative w-[330px] h-[150px] bg-black/25 border-solid border-white border-2 rounded-xl p-2 placeholder:text-white placeholder:font-light placeholder:text-2xl break-words text-white font-light focus:placeholder:text-transparent focus:outline-none focus:border-cerise resize-none ${
