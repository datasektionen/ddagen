...
export default function Contact() {
  ...
  return (
    <div className="py-[150px] flex flex-col items-center">
      ...
      <div className="flex flex-col-reverse md:flex-row mt-[100px] justify-center px-[30px] sm:px-[0px] gap-[50px] xl:pl-[100px] xl:gap-[120px] md:items-center ">
      ...
      <div className="flex flex-col md:flex-row mt-[100px] justify-center px-[30px] sm:px-[0px] gap-[50px] xl:pr-[100px] xl:gap-[120px] md:items-center ">
