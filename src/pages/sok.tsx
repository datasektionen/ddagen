  ...
  return (
    ...
    >
      <div className="py-[0px]">
        <img src={image} className="md:h-[300px] lg:h-[300px] rounded-xl grayscale"></img>
      </div>
      <div
          ...
          >
            ...
            >
              ...
              <div className="px-5 mt-5">
                ...
                <p className="text-black text-start mt-5">{}</p>
              </div>
            </div>  
          </div>
        )}
...
export default function Students() {
  ...
  return (
    <div className="pt-[200px] pb-[300px]">
      <h1 className="text-5xl text-cerise font-medium text-center uppercase"> {t.sok.header}</h1>
      <SingleEvent
        bgColor="bg-[#E2B7C9]"
