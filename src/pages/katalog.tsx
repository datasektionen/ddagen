...
function Packet(
    {price, icons, packetColor1, packetColor2, packetType, info, packetDescription}:
    {price:String; icons: Array<String>; packetColor1: String; packetColor2: String; packetType: String; info: String; packetDescription:Array<String>;}
    )
    {
    ...
    `}>
        ...
        <button onClick={() => hidePackage(!packetHidden)} className={` hover:scale-105 transition-transform hover:brightness-110 absolute h-[40px] w-[100px] ${packetColor2} rounded-[40px] border-cerise bottom-0 translate-y-1/2`} 
    ...
    <div className={`
    ${packetHidden ? " max-h-full py-[40px]"
              : "max-h-0 border-b-0 py-0"}
    md:w-[150px] lg:w-[200px] xl:w-[250px] 2xl:w-[300px] 
    px-[0px] transition-[max-height,padding] duration-200 overflow-y-hidden z-0 flex flex-col ${packetColor1} border-[3px] border-t-0 rounded-b-xl bg-opacity-10 text-center bg-slate-50 `}>
