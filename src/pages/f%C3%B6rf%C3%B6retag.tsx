    ...
    return (
        <div className="bg-slate-700 flex h-min-screen flex-col items-center">
            ...
            <div className="grid grid-cols-2 gap-y-16 bg-white/50 w-4/5 h-30 text-slate-700 py-16 px-8 mb-32">
                <div className="bg-white p-8 m-auto min-w-[20rem] z-10">
                ...
                <div className="flex m-auto justify-self-end flex justify-end w-full"><img className="bg-black min-w-[20rem] right-0"src="\img\for-companies-pic1.svg" alt="picture of people talking" /></div>
                <div className="flex mb-auto"><img className="bg-black "src="\img\for-companies-pic2.svg" alt="picture of people talking" /></div>
                <div className="bg-cerise text-black p-8 mb-auto mt-8 min-w-[20rem] justify-self-end">
