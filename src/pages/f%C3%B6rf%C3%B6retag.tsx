...
export default function Companies() {
    ...
    return (
        <div className="bg-[url('/img/website-background3.svg')]  bg-center flex h-min-screen w-full flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-16 bg-white/50 h-30 sm:w-4/5 py-16 sm:px-8 px-2 mx-2 mb-32">
                ...
                <div className="flex m-auto justify-self-end flex justify-end w-full"><img className="bg-black sm:min-w-[30rem] right-0"src="\img\for-companies-pic1.svg" alt="picture of people talking" /></div>
                <div className="flex mb-auto"><img className="bg-black "src="\img\for-companies-pic2.svg" alt="picture of people talking" /></div>
                <div className="bg-cerise text-black p-8 mb-auto sm:mt-8 sm:min-w-[20rem] justify-self-end">
