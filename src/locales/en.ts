export default {
      ...
      row1: {
        ...
        section2: {
          ...
          datamasters:{
            ...
            sustainableDigitalisation: "Sustainable Digitalisation",
            ICTInnovation: "ICT Innovation",
            embeddedSystems: "Embedded Systems",
            informationNetworkEngineering: "Information and Network Engineering",
            industrialManagement: "Industrial Management",
            interactiveMediaTechnology: "Interactive Media Technology",
            communicationSystems: "Communication Systems",
            machineLearning: "Machine Learning",
            medicalEngineering: "Medical Engineering",
            systemControl: "System, Control and Robotics",
            apliedMathematics: "Applied and Computational Mathematics",
            softwareEngineering: "Software Engineering of Distributed Systems",
          },
          otherMasters:{
            other: "Other",
          },
  ...
  map: {
    ...
    search: {
      ...
      buttonTwo: "Filters",
      filterYear: "Year",
      dataMasterPrograms: "Data Master Programs",
      otherMasterPrograms: "Other Master Programs",
    },
    floors: {
      one: "Floor 2",
      two: "Floor 3",
