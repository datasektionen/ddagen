export default {
  ...
  faq: {
    ...
    table2text1: "Absolutely, we have several different packages to help you reach more students, contact sales@ddagen.se for more information.",
    ...
    table3text1: "You can register at https://ddagen.se/en/förföretag or contact our sales team at sales@ddagen.se",
    table3text2: "Since we have a limited number of spots at our fair we recommend making a non-binding declaration of interest at https://ddagen.se/en/företagsanmälan",
