export default {
  ...
  faq: {
    ...
    table2text1: "Absolut, vi har flera olika paket för att ni ska kunna nå ut till fler studenter, kontakta sales@ddagen.se för mer info.",
    ...
    table3text1: "Ni får göra en intresseanmälan på https://ddagen.se/förföretag eller kontakta våra säljare på sales@ddagen.se",
    table3text2: "Eftersom vi har ett begränsat antal platser på vår mässa rekommenderar vi att ni gör en icke-bindande intresseanmälan på https://ddagen.se/företagsanmälan",
    ...
    table4text1: "Vi samarbetar gärna med er för att organisera evenemang före och efter D-Dagen! Oavsett om ni är intresserade av lunchföreläsningar, hackathons eller något helt annat är ni välkomna att dela era idéer med oss. För mer information kontakta vår sponsoransvarige på alexandre.moch@ddagen.se",
    download: "LADDA NED",
