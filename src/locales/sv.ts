export default {
  ...
  exhibitorSettings: {
    ...
    meetings: {
      ...
      columns3: ["Tid","Namn", "År", "CV", "Avboka Möte"],
      ...
      "<div style=\"padding:0;font-family:Arial, sans-serif;font-size: 16px; line-height:1.6; max-width: 600px; \">" +
        "<table style=\"box-sizing:border-box;background:#DE3163; border: 30px solid #14112A; border-width: 30px;border-color: #14112A;border-type: solid; padding: 0;color:#ffffff;border-radius:10px 10px 0 0; max-width: 600px;\" width=\"100%\">" +
          "<tbody>" +
            ...
            "<tr>" +
              "<div style=\"padding: 10px 30px 30px; background:#DE3163;color:#ffffff;\" >" +
                "<p style=\"color:#ffffff;\">Kom ihåg att det är först till kvarn på att välja tider bland de studenter som har erbjudits kontaktsamtal." +
                "<br />Vänliga hälsningar," +
                "<br />D-Dagen Projektgruppen" +
  ...
  faq: {
    ...
    table2text1:
      "Absolut, vi har flera olika paket för att ni ska kunna nå ut till fler studenter, kontakta <a className='text-yellow' href='mailto:sales@ddagen.se'>sales@ddagen.se</a> för mer info.",
    table2text2:
    ...
    table3text2:
      "Eftersom vi har ett begränsat antal platser på vår mässa rekommenderar vi att ni gör en icke-bindande intresseanmälan. För att göra detta, vänligen klicka här: <a href='https://ddagen.se/en/företagsanmälan' target='blank' className='underline text-yellow'> Anmälan </a>.",
    table3text3:
      "Om ni är intresserade av någon typ av större partnerskap kontakta <a className='text-yellow' href='mailto:ansvarig@ddagen.se'>ansvarig@ddagen.se</a>.",
    table3text4:
  ...
  catalog: {
    ...
    names: ["LILLA PAKETET",
      "MELLANPAKETET",
      "STORA PAKETET"],
    placement: ["Slumpmässig","God","Central"],
    exposure: ["Hemsida & katalog","Hemsida, katalog & goodiebag","Hemsida, katalog & goodiebag"],
    representatives: ["2 st","3 st","4 st"],
    sittningTickets: ["2 st","2 st","4 st"],
    drinkCoupons: ["8 st","8 st","16 st"],
    tables: ["1 st","1 st","1 st"],
    titles: [
      "PRIS",
      "MONTERYTA",
      "PLACERING",
  ...
  event: {
    ...
    calendar: {
      ...
      appleHint: "iPhone, iPad och Mac",
      download: "Ladda ner .ics",
      downloadHint: "Engångsimport, uppdateras inte",
      copy: "Kopiera kalenderlänk",
      copyShort: "Kopiera länk",
      copied: "Kopierad",
      sheetTitle: "Lägg till D-Dagens event",
      sheetSubtitle: "Prenumerera en gång, håller sig uppdaterad.",
  ...
  history: {
    ...
    subsubheader: "Klicka gärna på bilderna för mer information om varje år!",
    ...
    text2016: "Första mässan i kårhuset Nymble, istället för i E-huset. Första personen som valdes till den faktiska rollen som “D-Dagenansvarig”: Albin Söderholm som ansvarade för detta års mässa.",
    text2015: "",
