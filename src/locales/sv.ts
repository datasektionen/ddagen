export default {
  ...
  forStudents: {
    ...
    eventStaff: "Dagspersonal",
    eventStaffText:
      "D-Dagen behöver hjälp med att ta hand om alla företag och studenter som kommer på mässan. Både med alla förberedelser och så att allting flyter på bra under själva mässan. Är du intresserad av att hjälpa till som dagspersonal? Anmäl dig här!",
    eventStaffButton: "Dagspersonal",
  },
  exhibitorSettings: {
