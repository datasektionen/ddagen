export default {
  ...
  catalog: {
    ...
    titles: {
      ...
      placement: "PLACERING",
      exposure: "EXPONERING",
      representatives: "REPRESENTANTPLATSER",
      sittningTickets: "KVÄLLSSITTNINGSBILJETTER",
      drinkCoupons: "DRYCKESBILJETTER",
      companyHost: "DEDIKERAD FÖRETAGSVÄRD",
      lounge: "LOUNGETILLGÅNG",
      tables: "BORD",
      wifi: "EL OCH WIFI",
      sponsoredPost: "SPONSRAT INLÄGG",
      kontaktSamtal: "HALVDAG AV KONTAKTSAMTAL",
    },
